...
{   UserCalender c = new UserCalender();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        switch (perfil)
        {
            ...
            case "banco":
                PnFin.Visible = true;
                PnFinIII.Visible = true;
                PnFinBcoAux.Visible = true;
                PnFinBcoCondic.Visible = true;
                break;

            case "venta":
                 PnFin.Visible = true;
                 PnFinIII.Visible = true;
                 PnFinCxcAux.Visible = true;
            ...
            PnNom.Visible = true;
            PnNomI.Visible = true;
            PnNomII.Visible = true;
            break;
            #endregion
            
            #region Nomina y Produccion
            case "supNomPro":
            PnNom.Visible = true;
            PnNomII.Visible = true;
            ...
            PnFinCxpAux.Visible = true;
            PnFinCxcAux.Visible = true;
            PnFinInvAux.Visible = true;
            PnFinComAux.Visible = true;
            PnFinBcoCondic.Visible = true;
            PnFinFlijo.Visible = true;
            break;
            #endregion
            ...
            #region Super Usuario (Nomina y Super Usuario)
            case "supLv":
            pnCompra.Visible = true;
            pnCompraI.Visible = true;
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["p"].ToString() == "Operativo/BioStar/Asistencia Diaria")
            {
                try
                {
                    c.EliminarTabla();
            ...
            else { Imagen1.Visible = false; Panel1.Visible = true; Panel2.Visible = true; Path = "/MERSA/Visor de Reporte/" + Request.QueryString["p"].ToString(); }
