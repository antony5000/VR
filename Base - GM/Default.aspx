...
<body style="background-color: #EFEAE3;">
    <form id="form1" runat="server">
        <div class="">
            <%--Encabezado--%>
            <div class="grid condensed" style="margin: 0px; background: #001125;">
                <div class="row cells4">
                    <div class="cell colspan2" style="color: #ffffff;">
                       <%-- <img src="Imagen/GRUPO MERINO.png" style="width:120px; margin-left:20px; float: left;"/>--%>
                        <h2 style="font-family:'Century Gothic'; font-size:3rem; margin: 0px; float: left; margin-top: 5px; font-size: 2.0rem; padding-left: 20px;">GRUPO MERINO</h2>
                    </div>
            ...
            <%--Menu--%>
            <ul class="m-menu" style="background: #001125;">
                  <%--Inicio--%>
                <li>
...
<%--                                        <li><a href="#" style="width: 190px; cursor:pointer;" onclick="reporte('Operativo/Inventario/Inventario Actual Categorias')">Material de Empaque</a></li>
            ...
            <div class="main-content clear-float" style="background-color: white; float:none; margin: 0 auto; overflow: auto;"> 
                <asp:Image ID="Imagen1" runat="server" ImageUrl="~/Imagen/GMs.jpg" Style="width:100%; height:auto;"/>
            ...
            <div class="cell" style="width:172px; padding:5px; background:none; float: right; box-shadow: 0 0 20px 0 rgba(0, 0, 0, 0.25);">
                ...
                <input type="text" id="slider_input" name="user_login" runat="server" style="height:24px; width:32px; float: right; border:0px; padding:0px; background:#001125; color:white;" readonly="true" />
            <div class="slider large" 
                ...
                data-min-value="50"; 
                float: right; 
                style="width:100px; margin:0px; background-color:#001125;">
            </div>
            </div>               
            <script>
       ...
       <%--PIE DE PAGINA Fijo---%>
    <div class="align-right" style="bottom:0; padding-bottom: 0px;position: fixed; text-align:right; width: 100%; background: #001125; color: white; padding:2px; z-index:99;"> 
        <p style="text-align:center; width:50%; float: left; margin:0px; font-family:'TradeGothicLTStd-Bd2'; font-size:10px;"><a <%--href="http://www.mersan.com.ve "target="_blank";--%>  style="color:white; text-decoration: underline; font-family:'Century Gothic'; font-size:18px; color:#E97D26; padding-left:5px;">GRUPO MERINO</a> Todos Los Derechos Reservados © 2015  </p> 
