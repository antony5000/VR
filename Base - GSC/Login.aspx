...
<body class="fondo">
    <div class="login-form padding block-shadow">
       <%-- <img src="Imagen/IGCAR.png" style="width:45px; margin-left: 20px; float: left;padding-left: 0px;margin-top: 10px; margin-bottom: 10px; margin-right: 0px;">--%>
        <h2 class="loginh2" style="text-align: center; background: rgba(0, 0, 0, 0.2); margin-top: 0px; margin-bottom: 0px; padding-bottom: 10px; padding-top: 10px; color: #53556B;  font-family: 'ERASBD'; font-size: 1.6rem;  padding-top:20px; padding-bottom:20px;">Granja Santa Clara</h2>
