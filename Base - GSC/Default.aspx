...
<body style="background-color: #EFEAE3;">
    <form id="form1" runat="server">
        <div class="">
            <%--Encabezado--%>
            <div class="grid condensed" style="margin: 0px; background: #2392A4;">
                <div class="row cells4">
                    <div class="cell colspan2" style="color: #ffffff;">
                  <%--      <img src="Imagen/IGCAR.png" style="width:65px; margin-left:20px; float: left;"/>--%>
                        <h2 style="font-family: 'ERASBD'; font-size:3rem; margin: 0px; float: left; margin-top: 25px; font-size: 1.8rem;">Granja Santa Clara</h2>
                    </div>
            ...
            <%--Menu--%>
            <ul class="m-menu" style="background: #2392A4;">
                  <%--Inicio--%>
                <li>
                 ...
                 <li>
                    ...
                    <div class="m-menu-container" data-role="dropdown">
                        <asp:Panel ID="pnVenta" runat="server" Visible="false">
                            <div style="padding-top:10px;">
                            <ul class="t-menu">           
                                <li id="pnVentaI" runat="server" visible="false"><a href="#" class="dropdown-toggle">Factura</a>
                                 <ul class="t-menu" data-role="dropdown">                                         
                                     <li><a href="#" style="width: 180px; cursor:pointer;" onclick="reporte('Proagro/Orden de Compra')">Proagro</a></li>
                                </ul>
                                </li>                                
                               ...
                               <%-- <li id="pnInvI" runat="server" visible="false"><a href="#" class="dropdown-toggle">Consumo</a>
                                ...
                                <li id="pnInvII" runat="server" visible="false"><a href="#" class="dropdown-toggle">Stock</a>
                                    <ul class="t-menu" data-role="dropdown" style="">
                                        <li><a href="#" style="width: 190px; cursor:pointer;" onclick="reporte('Inventario/Articulos Actual')">Articulos</a></li>
<%--                                        <li><a href="#" style="width: 190px; cursor:pointer;" onclick="reporte('Operativo/Inventario/Inventario Actual Categorias')">Material de Empaque</a></li>
                        ...
                        <div style="padding-top:10px;">
                            <ul class="t-menu">
                                ...
                                <li id="PnFinIII" runat="server" visible="false"><a href="#" class="dropdown-toggle">Auxiliares</a>
                                  <ul class="t-menu" data-role="dropdown">
                                     <li id="PnFinBcoAux" runat="server" visible="false"><a href="#" style="width: 245px; cursor:pointer;" onclick="reporte('Finanzas/Auxiliar Banco')">Bancos</a></li>
                                     <li id="PnFinCxpAux" runat="server" visible="false"><a href="#" style="width: 245px; cursor:pointer;" onclick="reporte('Finanzas/Auxiliar Cuentas por Pagar')">Cuentas por Pagar</a></li>
                                     <li id="PnFinCxcAux" runat="server" visible="false"><a href="#" style="width: 245px; cursor:pointer;" onclick="reporte('Finanzas/Auxiliar Cuentas por Cobrar')">Cuentas por Cobrar</a></li>
                                     <li id="PnFinInvAux" runat="server" visible="false"><a href="#" style="width: 245px; cursor:pointer;" onclick="reporte('Finanzas/Auxiliar Inventario')">Inventario</a></li>
                                  </ul>
                                </li>  
                                <li id="PnFinI" runat="server" visible="false"><a href="#" class="dropdown-toggle">Estado Financiero</a>
                                    <ul class="t-menu" data-role="dropdown">
                                        <li><a href="#" style="width: 180px; cursor:pointer;" onclick="reporte('Finanzas/Balance de Comprobacion')">Balance de Comprobacion</a></li>
                                    </ul>
                                </li> 
                                 <li id="PnFinBcoCondic" runat="server" visible="false"><a href="#" style="width: 245px; cursor:pointer;" onclick="reporte('Finanzas/Conciliacion Bancaria')">Conciliacion Bancaria</a></li>
                                 <li id="PnFinFlijo" runat="server" visible="false"><a href="#" style="width: 245px; cursor:pointer;" onclick="reporte('Finanzas/Flujo de Caja')">Flujo de Caja</a></li>
                            </ul>
                         </div>
                        </asp:Panel>
                        <div style="width: 100%; height: 4px; top: 98%; background-color: rgba(27, 161, 226, 0.82);"></div>
            ...
            <div class="main-content clear-float" style="background-color: white; float:none; margin: 0 auto; overflow: auto;"> 
                <asp:Image ID="Imagen1" runat="server" ImageUrl="~/Imagen/fondogcs2.png" Style="width:100%; height:auto;"/>
    ...
    <div class="align-right" style="bottom:0; padding-bottom: 0px;position: fixed; text-align:right; width: 100%; background: #56586B; color: white; padding:2px; z-index:99;"> 
        <p style="text-align:center; width:50%; float: left; margin:0px; font-family:'TradeGothicLTStd-Bd2'; font-size:10px;"><a <%--href="http://www.mersan.com.ve" target="_blank";--%> style="color:white; text-decoration: underline; font-family: 'ERASBD'; font-size:20px; color:#B7B7B7; font-size:0.875rem; padding-left:5px;">Granja Santa Clara</a> Todos Los Derechos Reservados © 2015  </p> 
