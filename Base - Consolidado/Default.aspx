...
<body style="background-color: #EFEAE3;">
    <form id="form1" runat="server">
        <div class="">
            ...
            <div class="grid condensed" style="margin: 0px; background: #1f497d;">
                <div class="row cells4">
                    <div class="cell colspan2" style="color: #ffffff;">
                        <h2 style="padding-left: 28px;  font-family:'BebasNeueM'; font-size:3rem; margin: 0px;">GRUPO MERINO</h2>
                    </div>
                            ...
                            <ul class="t-menu">
                               ...
                               <%-- <li id="PnFinI" runat="server" visible="false"><a href="#" class="dropdown-toggle">Estado Financiero</a>
                                ...
                                <%--<li id="PnFinII" runat="server" visible="false"><a href="#" class="dropdown-toggle">Estimaciones</a>
                                 ...
                                 <li id="PnFinBcoCondic" runat="server" visible="false"><a href="#" style="width: 245px; cursor:pointer;" onclick="reporte('Finanza/Conciliacion Bancaria')">Conciliacion Bancaria</a></li>
            ...
            <div class="main-content clear-float" style="background-color: white; float:none; margin: 0 auto; overflow: auto;"> 
                <asp:Image ID="Imagen1" runat="server" ImageUrl="~/Imagen/CuboLuz2.jpg" Style="width:100%; height:auto;"/>
    ...
    <div class="align-right" style="bottom:0; padding-bottom: 0px;position: fixed; text-align:right; width: 100%; background: slategray; color: white; padding:2px; z-index:99;"> 
        <p style="text-align:center; width:50%; float: left; margin:0px; font-family:'TradeGothicLTStd-Bd2'; font-size:10px;"><a href=""  target="_blank"; style="color:white; text-decoration: underline; font-family:'BebasNeueM'; font-size:20px; color:#1f497d; padding-left:5px;">GRUPO MERINO</a> Todos Los Derechos Reservados © 2015  </p> 
