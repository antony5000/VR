...
<head>
    ...
    <style>
        ...
        .fondo {
            background:#1f497d; 
            background-image: url(Imagen/cubeC.png); 
...
<body class="fondo">
    <div class="login-form padding block-shadow">
        <h2 class="loginh2" style="text-align: center; background: rgba(0, 0, 0, 0.2); margin-top: 0px; margin-bottom: 0px; padding-bottom: 10px; padding-top: 10px; color: #1f497d; font-family:'BebasNeueM'; font-size:3rem;  padding:0px; padding-top:5px;">GRUPO MERINO</h2>
        <form id="form1" runat="server" class="padding20">
            ...
            <div class="form-actions">
                <asp:Button ID="IniciarSesion" runat="server" Text="Iniciar Sesión" BackColor="#1f497d" ForeColor="White" OnClick="IniciarSesion_Click" />
                <button type="button" class="button link" style="color:#1f497d;">Cancelar</button>
            </div>
            <br />
            <br />
            <br />
    ...
    <div class="align-right" style="bottom:0; padding-bottom: 0px;position: fixed; text-align:right; width: 100%; background: slategray; color: white; padding:2px; z-index:99;"> 
        <p style="text-align:center; width:50%; float: left; margin:0px; font-family:'TradeGothicLTStd-Bd2'; font-size:10px;"><a <%--href="http://www.mersan.com.ve"--%> target="_blank"; style="color:white; text-decoration: underline; font-family:'BebasNeueM'; font-size:20px; color:#1f497d; padding-left:5px;">GRUPO MERINO</a> Todos Los Derechos Reservados © 2015  </p> 
