...
<body class="fondo">
    <div class="login-form padding block-shadow">
        <h2 class="loginh2" style="text-align: center; background: rgba(0, 0, 0, 0.2); margin-top: 0px; margin-bottom: 0px; padding-bottom: 10px; padding-top: 10px; color: #1f497d; font-family:'BebasNeueM'; font-size:3rem;  padding:0px; padding-top:5px;">MERSAN</h2>
